...
PRODUCT_PACKAGES += consumerir.mt6795
endif
...
#add MIUI bin Start
PRODUCT_PACKAGES += bmi160d
PRODUCT_PACKAGES += consumerird
PRODUCT_PACKAGES += lsm6ds3d
PRODUCT_PACKAGES += yamaha537
#add MIUI bin End
...
PRODUCT_PACKAGES += mpud6050
PRODUCT_PACKAGES += lights.mt6795
PRODUCT_PACKAGES += lights.mt6595
...
PRODUCT_PACKAGES += libhr
PRODUCT_PACKAGES += shutdown
PRODUCT_PACKAGES += WIFI_RAM_CODE
PRODUCT_PACKAGES += WIFI_RAM_CODE_E6
PRODUCT_PACKAGES += WIFI_RAM_CODE_MT6628
...
PRODUCT_PACKAGES += powervr.ini
PRODUCT_PACKAGES += libufwriter
PRODUCT_PACKAGES += libmemtrack_GL
PRODUCT_PACKAGES += memtrack.mt6795
...
PRODUCT_PACKAGES += libmnlp_mt6630
...
PRODUCT_PACKAGES += md32_p.bin
PRODUCT_PACKAGES += md32_d.bin

PRODUCT_PACKAGES += fstab.mt6795
PRODUCT_PACKAGES += fstab.mt6595
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6582))
    PRODUCT_PACKAGES += gralloc.mt6582
...
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.mt6795.rc:root/init.mt6795.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.mt6595.rc:root/init.mt6595.rc

PRODUCT_COPY_FILES += device/mediatek/mt6795/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/init.modem.rc:root/init.modem.rc

PRODUCT_COPY_FILES += device/mediatek/mt6795/ueventd.mt6795.rc:root/ueventd.mt6795.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/ueventd.mt6595.rc:root/ueventd.mt6595.rc

#ifeq ($(strip $(MTK_FAT_ON_NAND)),yes)
#PRODUCT_COPY_FILES += device/mediatek/mt6795/init.fon.rc:root/init.fon.rc
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6795.fon:root/fstab.mt6795
#endif

PRODUCT_COPY_FILES += device/mediatek/mt6795/init.xlog.rc:root/init.xlog.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6795/egl.cfg:system/lib/egl/egl.cfg
#ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6795:root/fstab.mt6795
#else
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6795.nand:root/fstab.mt6795
#endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6795/media_codecs.xml:system/etc/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6795/media_codecs_performance.xml:system/etc/media_codecs_performance.xml
PRODUCT_COPY_FILES += device/mediatek/mt6795/media_codecs_mediatek_audio.xml:system/etc/media_codecs_mediatek_audio.xml
PRODUCT_COPY_FILES += device/mediatek/mt6795/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml
PRODUCT_COPY_FILES += device/mediatek/mt6795/media_codecs.xml:system/etc/permissions/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6795/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg
...
#audio config file
PRODUCT_COPY_FILES += device/mediatek/mt6795/audio_device.xml:system/etc/audio_device.xml

ifeq ($(MTK_CLEARMOTION_SUPPORT),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6795/mtk_clear_motion.cfg:system/etc/mtk_clear_motion.cfg
endif
...
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  PRODUCT_PACKAGES += keystore.mt6795
  PRODUCT_COPY_FILES += device/mediatek/mt6795/init.trustonic.rc:root/init.trustonic.rc
endif
...
#inherit prebuilt
$(call inherit-product-if-exists, vendor/mediatek/mt6595/device-vendor.mk)
