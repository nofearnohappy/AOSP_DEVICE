...
# installclean
ifneq ($(filter $(_product_var_list),$(MTK_REMAKE_DELETED_PRODUCT_CONFIG_OPTIONS))$(filter ALL_MODULES,$(MTK_REMAKE_CHANGED_PROJECT_CONFIG_OPTIONS)),)
ifeq ($(filter mtk-remake-dump,$(MAKECMDGOALS)),)
...
ifneq ($(filter $(_product_var_list),$(MTK_REMAKE_CHANGED_PRODUCT_CONFIG_OPTIONS)),)
