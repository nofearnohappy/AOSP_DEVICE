...
$(call inherit-product, device/vanzo/vz6795_lwt_m/device.mk)
...
PRODUCT_NAME := full_vz6795_lwt_m
PRODUCT_DEVICE := vz6795_lwt_m
PRODUCT_MODEL := vz6795_lwt_m
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= hermes_defconfig
else
KERNEL_DEFCONFIG ?= hermes_defconfig
endif
#PRELOADER_TARGET_PRODUCT ?= vz6795_lwt_m
#LK_PROJECT ?= vz6795_lwt_m
#TRUSTY_PROJECT ?= vz6795_lwt_m
