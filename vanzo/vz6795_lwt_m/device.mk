...
# PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/ueventd.mt6795.rc:root/ueventd.mt6795.rc

PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/vanzo/vz6795_lwt_m/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# thermal policy
ifneq ($(TARGET_BUILD_VARIANT),user)
    PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/thermal.wfd.6795.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/thermal.6795.conf:system/etc/.tp/thermal.conf
endif
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/thermal.off.6795.conf:system/etc/.tp/thermal.off.conf
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/thermal.wfd.6795.conf:system/etc/.tp/.thermal_policy_00
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/thermal.pip.6795.conf:system/etc/.tp/.thermal_policy_01
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/ht120.6795.mtc:system/etc/.tp/.ht120.mtc
...
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6795_lwt_m/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6795_lwt_m/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6795/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6795_lwt_m/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6795_lwt_m/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/vz6795_lwt_m/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png

# USB
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/init.mt6795.usb.rc:root/init.mt6795.usb.rc

# SmartPA parameters
ifeq ($(strip $(NXP_SMARTPA_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/coldboot.patch:system/etc/smartpa_params/coldboot.patch
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/devkit_Release.parms:system/etc/smartpa_params/devkit_Release.parms
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/HQ_KS_13X18_DUMBO.eq:system/etc/smartpa_params/HQ_KS_13X18_DUMBO.eq
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/HQ_KS_13X18_DUMBO.preset:system/etc/smartpa_params/HQ_KS_13X18_DUMBO.preset
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/KS_13X18_DUMBO_tCoef.speaker:system/etc/smartpa_params/KS_13X18_DUMBO_tCoef.speaker
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/TFA9887_N1D2_2_4_1.patch:system/etc/smartpa_params/TFA9887_N1D2_2_4_1.patch
PRODUCT_COPY_FILES += device/vanzo/vz6795_lwt_m/paparams/TFA9887_N1D2.config:system/etc/smartpa_params/TFA9887_N1D2.config
endif

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/vanzo/vz6795_lwt_m/overlay
